...
let out01 = '';
for (let key in a01) {
   // out01 += key; // выводит ключи
   // out01 += a01[key]; // выводит элементы
   out01 += key + '---' + a01[key] + "<br>"; // выводит ключ и элемент
}
...
// нажатии кнопки b-4. Формат вывода - ключ пробел значение перенос 
...
// Давайте напишем функцию f5, которая принимает массив как параметр и 
// выводит его в формате указанном в функции в указанный блок (как второй параметр).
...
// Функция должна получать из i-61 ключ, а из i-62 значение и добавлять его 
// в массив a6. После этого, с помощью функции f5 выводите массив a6 в out-6.
...
function f6() {
   ...
   return document.querySelector('.out-6').innerHTML = out;
}
...
// Функция должна выводить значение в out-8, если ключ введенный 
// в i-8 есть в массиве, если нет - 0.
...
// значение в ассоциативном массиве. Фукнция должна возвращать true 
// если есть, и false если нет. Массив и значение передавать функции 
...
// текст как с большой, так и с маленькой буквы. Если ветка не найдена - выводите пустую строку.
