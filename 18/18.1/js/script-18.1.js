//! 18 JavaScript v2.0 Изучаем split, join, forEach
/*
...
console.log(a); /// hello, hi, mahai
console.log(a.split()); // ['hello, hi, mahai']
console.log(a.split('')); // ['h', 'e', 'l', 'l', 'o', ',', ' ', 'h', 'i', ',', ' ', 'm', 'a', 'h', 'a', 'i']
console.log(a.split(',')); // это метод и необходимо указывать круглые скобки split() //['hello', ' hi', ' mahai']
...
//!метод join() превращает массив в строку. Исходный массив не меняется.

let b02 = ['h', 'e', 'l', 'l', 'o'];
let c01 = b02.join() // если () получим строку h,e,l,l,o
...
// есть список данных. Необходимо сформировать массив с именем или почтой или возраст
const date = [
   {
      id: 1,
      name: 'Mario',
...
date.forEach(function (elem) {
   getEmail.push(elem.email) // вытащили всю почту
   getUserName.push(elem.name) // вытащили все имена
});
...
запускаться при клике и добавлять атрибут data элемента, по которому кликнули в массив a5_res.*/
...
// Task 7 ============================================
/*  Дана строка str7='hello world hi mazai' - преобразуйте ее в массив и 
разбейте по словам. Причем слова не должны содержать пробелов и присвойте a6_res. 
...
Разделитель - дефис. Результат присвойте a8_res. Запускаться решение должно при вызове функции t8. */
...
Разделитель - дефис. Результат присвойте a9_res. Запускаться решение 
должно при вызове функции t9. Допускается лишний дефис в конце строки!!! */
...
// Task 10 ============================================
/*  Дан массив a10 = {name: ivan, age: 15, sex: 1, id: 45} - преобразуйте 
его в query строку ( так передаются GET параметры). Найдите описание что 
такое query строка самостоятельно. Разделитель - амперсанд. 
...
Параметры в URL могут содержать кучу полезной информации: данные о товаре, пользовательские 
настройки, идентификатор партнёра. В этой статье посмотрим как через JS можно извлечь данную информацию.
