...
let t01 = a12[0]; // Хранится в элементе [0] значение 1.
...
// Ставим -1 так как отсчет начинается с 0 и ненайдет последний элемент
let a13 = [5, 6, 7, 8];
console.log(a13);
// Создаем временную переменную куда кладем значения 0-го элемента
let t02 = a13[0]; // Хранится в элементе [0] значение 1.
// Теперь запишем 4-ку эл[3] на место 1-цы эл[0].
a13[0] = a13[a13.length - 1];
// Теперь перезапишем 4-ку эл[3]. Присвоем ему 1-цы эл[0]
a13[a13.length - 1] = t02;
console.log(a13);
...
// Task 12
// Напишите функцию f12, которая меняет местами нулевой и последний элемент массива 
// ar12 и выводит его в out-12. Разделитель - пробел. Последний элемент вычислять 
// через длину массива.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
